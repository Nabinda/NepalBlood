...
class _RequestBloodState extends State<RequestBlood> {
  ...
  final errorSnackBar = SnackBar(content: Text("Error Occurred while creating request"));
  ...
  addRequest() async{
    ...
    if (_form.currentState.validate()) {
      ...
      await Provider.of<BloodRequestsProvider>(context,listen: false).addRequest(
